...
if __name__ == '__main__':
    ...
    parser.add_argument('--db_name', type=str, default='moad')
    parser.add_argument('--path_df', type=str, default='./data_train/moad/dfs/meta_uni.csv')
    parser.add_argument('--root', type=str, default='./data_train/moad/files')
