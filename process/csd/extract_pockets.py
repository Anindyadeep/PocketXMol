...
if __name__ == '__main__':
    ...
    parser.add_argument('--db_name', type=str, default='csd')
    parser.add_argument('--path_df', type=str, default='./data_train/csd/dfs/meta_filter_w_pocket.csv')
    parser.add_argument('--root', type=str, default='./data_train/csd/files')
