...
if __name__ == '__main__':
    ...
    # data dir
    pockets_dir = 'data_train/pbdock/files/pockets10'
    mols_dir = 'data_train/pbdock/files/mols'
    save_path = 'data_train/pbdock/lmdb/pocmol10.lmdb'
    # df dir
    df_use = pd.read_csv('data_train/pbdock/dfs/meta_filter_w_pocket.csv')
